...
namespace MyBlog.Service
{
    ...
    {   
        //inherit child class(BaseRepository) functions and get data from database
        ...
        {
            return await _iBaseRepository.DelteAsync(id);
        }
        ...
        {
            return await _iBaseRepository
               .QueryAsync(func, page, size, total);
        }
    }
}
